...
#Roles en la página:
INSERT INTO rols (name_rol) values ('admin');
INSERT INTO rols (name_rol) values ('user');


#Creación de país colombia.
INSERT INTO countries (code, name) values (170, 'Colombia');

#Creación de departamentos.
INSERT INTO departments (`code`, `code_country_department`, `name`) VALUES
('11', 170, 'BOGOTÁ D.C.'),
('13', 170, 'BOLÍVAR'),
('15', 170, 'BOYACÁ'),
('17', 170, 'CALDAS'),
...
('50', 170, 'META'),
('52', 170, 'NARIÑO'),
('54', 170, 'NORTE DE SANTANDER'),
('63', 170, 'QUINDÍO'),
('66', 170, 'RISARALDA'),
('68', 170, 'SANTANDER'),
('70', 170, 'SUCRE'),
('73', 170, 'TOLIMA'),
('76', 170, 'VALLE DEL CAUCA'),
('8', 170, 'ATLÁNTICO'),
('81', 170, 'ARAUCA'),
('85', 170, 'CASANARE'),
('86', 170, 'PUTUMAYO'),
('88', 170, 'ARCHIPIÉLAGO DE SAN ANDRÉS, PROVIDENCIA Y SANTA CATALINA'),
('91', 170, 'AMAZONAS'),
('94', 170, 'GUAINÍA'),
('95', 170, 'GUAVIARE'),
('97', 170, 'VAUPÉS'),
